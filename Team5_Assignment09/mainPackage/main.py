...
# Brief Description of the assignment: This is a program that uses a Pokemon API to pull information from a massive JSON database
#                                      about Pokemon. We chose to pull info on Maddy's favorite Appletun.
...
# Matt worked on the GitHub and architecure of the code
